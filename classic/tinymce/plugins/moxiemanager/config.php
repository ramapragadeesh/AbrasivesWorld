<?php
	...
	$moxieManagerConfig['upload.maxsize'] = '2MB';
	...
	$moxieManagerConfig['upload.max_width'] = 400;
	$moxieManagerConfig['upload.max_height'] = 300;
...
/*
	...
	$moxieManagerConfig['CodeIgniterAuthenticator.logged_in_key'] = "isLoggedIn";
...
*/	
	...
	// AutoFormat plugin
	$moxieManagerConfig['autoformat.rules'] = '320x240|JPG=%f_%w_%h.JPG,320x240=%f_%w_%h.%e';
