...
<div style="width:1024px;margin-top:-18px;margin-left:auto;margin-right:auto;background-color:whitesmoke">
							...
							<div class="list_carousel" style="height:140px">
								<ul id="foo5">
									<li style="height:60px">
										...
										<div class="capc">
											<h6>
												<?php echo dp($homepage_holder,"Leader in production machine for bonded and coated abrasives");?>
											</h6>
										</div>
									</li>
