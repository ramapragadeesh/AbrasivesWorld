		...
		<div class="row" >
			<div class="col-xs-3">
				<div class="offer offer-default">
					...
					<span style="padding-right:20px;"><i class="icon-pencil"></i><span style="padding-left:5px;cursor:pointer;font-weight:bold" onclick="article_manage(1)" ><?php echo dp($info_holder,"Create a new article");?></span></span>
					<span style="padding-right:20px"><i class="icon-edit"></i><span style="padding-left:5px;cursor:pointer;font-weight:bold" onclick="article_manage(2)" ><?php echo dp($info_holder,"Manage my article");?></span></span>
...
<div style="text-align:center;width:90%;min-width:500px;margin-left:20px;">
<div class="container" style="text-align:center;">
<div class="row">
<div class="span12" id="updu">
<div class="alert alert-success" id="upcmc">
  <strong id="upcmh" style="font-weight:bold;color:maroon"><?php echo json_encode(dp($info_holder,"Message"));?></strong>
  ...
  <?php echo json_encode(dp($info_holder,"Please, do not use any offensive words in your article"));?>
  <p>
	Please note that not all the video formats can be played in all the broswers.Certain video formats can only be played by specific browser.	
	</p>
	<p>
	For more information , <a target="_blank" href="http://www.w3schools.com/html/html5_video.asp">please click here </a>
	</p>
...
?>
			...
			<input type="text" name="scw_arttitle" id="scw_arttitle" value="<?php echo htmlspecialchars($_SESSION["scw_arttitle"]);?>" required="required"/>
			...
			<input type="text" name="scw_artauthor" id="scw_artauthor" value="<?php echo htmlspecialchars($_SESSION["scw_artauthor"]);?>" required="required"/>
			<span style="display:none" id="scw_arttitlei">
			<b style="color:orange">
			<?php echo dp($info_holder,"Please fill up this information");?>
			</b>
			...
			<input type="text" name="scw_artregcompany" id="scw_artregcompany" value="<?php echo htmlspecialchars($_SESSION["user_morgname"]);?>" readonly />
			</div>

			<div class="padme">
			<label for="scw_artdate" class="description btext"><?php echo dp($info_holder,"Article Date");?></label>
			<input type="text" name="scw_artdate" id="scw_artdate" value="<?php echo htmlspecialchars($_SESSION["scw_artdate"]);?>" required="required"/>
			<span style="display:none" id="scw_arttitlei">
			<b style="color:orange">
			<?php echo dp($info_holder,"Please fill up this information");?>
			</b>
			...
			<span>
			<input style="margin:0px 0px 0px 0px" type="checkbox"  value="posthome" name="posthome" id="posthome" <?php echo $_SESSION["scw_home"];?>/> 
			<span>
			...
			<input type="checkbox" id="jshowbygroupc" style="margin:0px 0px 0px 0px"/> <?php echo dp($info_holder,"By member group");?>
			</a>
			</span>			
			</div>
			...
			<br/>
			<span>
			<input type="text" name="newarticleemail" class="typeahead" id="newarticleemail" style="width:200px;" value="<?php echo htmlspecialchars($_SESSION["scw_targetemail"]);?>"/>
			...
			<br/>
			<?php echo dp($info_holder,"You can enter more than one email separted by , for example email1@domain.com,email2@domain.com");?>
			</div>
			</div>
			...
			<span><input  id="saveasdraft" type="button" value="<?php echo dp($info_holder,"save as draft");?>" class="btn"></span>
			<span><input  id="newarticleformsubmit" type="button" value="<?php echo dp($info_holder,"save and post article");?>" class="btn"></span>
...
<div class="alert alert-warning" style="width:800px;margin-left:100px">
  ...
  <h5><?php echo dp($info_holder,"Hi, You are not subscribed to Article module.");?></h5>
  <p></p>
...
<div id="managemyarticle" style="margin-top:10px;margin-left:20px; width:90%;min-width:500px;display:none">
<div style="border:3px solid whitesmoke">
<p style="font-weight:bold;font-size:15px;padding-left:30px;height:20px;background-color:whitesmoke"> <?php echo dp($info_holder,"Article Management");?> </p>
  ...
  <div style="display:none" class="modal fade" id="ArticleSaveModal" tabindex="-3" role="dialog" aria-labelledby="ArticleSaveModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" id="savearticle" class="btn btn-default" data-dismiss="modal"><?php echo dp($info_holder,"OK");?></button>
		   <button type="button" id="cancelarticle" class="btn btn-default" data-dismiss="modal"><?php echo dp($info_holder,"Close");?></button>
         </div>
      </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
  </div><!-- /.modal -->
