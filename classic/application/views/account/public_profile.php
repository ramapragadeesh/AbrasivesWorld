...
<b><?php echo dp($info_holder,"Company fact sheet");?></b>
</div>
...
<table>
		 ...
		 ?>		 
		  <tr style="line-height:30px">
		 <td>
		<b> <?php echo dp($info_holder,"Email");?></b>
		 </td>		 
		 <td>
		 <?php echo htmlentities($adu[0]->user_email);?>
		 </td>		 
		 </tr>		 
		  <?php
...
?>
	...
	<div style="margin-top:20px">
	<b> <?php echo dp($info_holder,"Abrasivesworld Profile Card");?> </b>
	</div>
	<div id="bc" style="margin-top:15px;margin-bottom:20px">
	<div class="business-card">
  <header>
  <?php echo $adu[0]->user_orgname; ?>  
  </header>
  <footer>
    <span class="contact-title">
      <?php echo dp($info_holder,"Contact :");?> 
    </span>
    <ul>
	<li>
	<br/>
