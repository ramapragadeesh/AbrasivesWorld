		...
		<div class="row" >
			<div class="col-xs-3">
				<div class="offer offer-default">
					...
					<span style="padding-right:20px;"><i class="icon-lock"></i><span style="padding-left:5px;cursor:pointer;font-weight:bold"><a href="<?php echo base_url();?>rfq">Create a new RFQ</a></span></span>
					<span style="padding-right:20px"><i class="icon-edit"></i><span style="padding-left:5px;cursor:pointer;font-weight:bold"><a href="<?php echo base_url();?>rfq/rfq_manage">Manage my RFQ</a></span></span>
					</div>
					</div>
				</div>
			</div>
