...
<b><?php echo dp($info_holder,"RFQ Bidding Response for ");?> <?php echo $rfqm[0]->rfq_title;?></b>
</div>
</div>
<div id="maincon">
		...
		<div class="row" >
			<div class="col-xs-3">
				<div class="offer offer-default">
					...
					<?php echo dp($info_holder,"You have participated in this RFQ");?> <b>
					</div>
					</div>
					</div>
				</div>
...
<td>
<input type="text" name="rfq_issuedate"  id="rfq_issuedate" value="<?php echo $rfqm[0]->rfq_issue_date;?>" required="required" disabled/>
...
<td>
<input type="text" name="rfq_closedate"  id="rfq_closedate" value="<?php echo $rfqm[0]->rfq_close_date;?>" required="required" disabled/>
...
<td>
<input type="text" name="rfqcexports"  id="rfqcexports" data-items="4" data-provide="typeahead" value="<?php echo $rfqm[0]->rfq_pref_cn_export;?>" required="required" readonly/>
</td>
...
<td>
<select name="rfqcurrency" id="rfqcurrency" readonly disabled>
...
<td>
<select name="rfqqval" id="rfqqval" readonly disabled>
...
<td>
<select name="rfqincoterm" id="rfqincoterm" readonly disabled>
...
<td>
<select name="rfqpship" id="rfqpship" readonly disabled>
...
<tfoot>
<tr><td></td><td></td><td></td><td></td><td></td><td><b><?php echo dp($info_holder,"");?></b></td><td><b></b></td></tr>
</tfoot>
</table>
...
<div style="border:3px solid whitesmoke">
<p style="font-weight:bold;font-size:15px;padding-left:30px;height:20px;background-color:whitesmoke;text-align:left"><?php echo dp($info_holder,"Attached Documents");?></p>
