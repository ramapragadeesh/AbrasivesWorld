...
if ($v->rfq_active==1)
{
$r .="<td><span>".'<a href="rfq_summary_view/?rfq_id='.$v->rfq_id.'"><span class="badge">'.rfq_bid_summary($rfqsummary,$v->rfq_id).'</span></a> </td><td><a href="rfq_modify/?rfqid='.$v->rfq_id.'"><i class="icon-edit"></i></a></td><td></td>';
}
else
{
$r .="<td><span>".'<a href="rfq_summary_view/?rfq_id='.$v->rfq_id.'"><span class="badge">'.rfq_bid_summary($rfqsummary,$v->rfq_id).'</span></a> </td><td><a href="rfq_modify/?rfqid='.$v->rfq_id.'"><i class="icon-edit"></i></a></td><td> &nbsp;&nbsp;<i style="cursor:pointer"class="icon-remove-circle" onclick="remove_rfq(\''.$v->rfq_id.'\');"> </i>'."</span></td>";
}
...
$r .='<td><span><a href="'.base_url().'rfq/rfq_bid_details/?rfqid='.$v->rfq_id.'"><i class="icon-info-sign"></i></a></span></td>';
$r .="</tr>";
}
return $r;
}
...
<th>
<?php echo dp($info_holder,"Response");?>
</th>
...
<th>
<?php echo dp($info_holder,"Preferred Currency");?>
</th>
